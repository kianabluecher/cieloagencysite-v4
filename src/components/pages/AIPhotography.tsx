...
export function AIPhotography({ onNavigate }: AIPhotographyProps) {
  const faqs = [
    {
      question: "Can AI-generated images replace real photography for brands?",
      answer: "Not entirely—but for most use cases, yes. AI excels at: Product staging and lifestyle shots, Concept visualization and mood boards, High-volume content (ads, social, email), Budget-friendly hero imagery. Still need real photography for: authentic team shots, behind-the-scenes content, high-stakes brand campaigns where 'real' matters."
    },
    {
      question: "How much does AI photography cost vs traditional shoots?",
      answer: "Traditional brand photoshoots: $3K–$15K per day (photographer, stylist, location, models, post-production). AI photography services: $500–$2K for 20–50 custom, photorealistic images. ROI is undeniable—especially for startups and growth-stage brands testing creative fast."
    },
    {
      question: "What industries benefit most from AI-generated images?",
      answer: "E-commerce, SaaS, real estate, hospitality, fintech, CPG, and any brand that needs high-volume visual content without traditional production costs. If you're running 10+ ad variations per month, AI imaging is a no-brainer."
    },
    {
      question: "Are AI-generated images 'good enough' for professional brands?",
      answer: "Yes—if done right. The difference is in the prompt engineering, refinement, and art direction. Stock AI tools (MidJourney, DALL·E) get you 70% there. Professional AI agencies bring the last 30%: lighting consistency, brand color accuracy, composition, and post-production polish."
    },
    {
      question: "Can I use AI-generated images for paid ads and social media?",
      answer: "Absolutely. Platforms like Meta, Google Ads, LinkedIn, and TikTok all accept AI-generated visuals. Brands using AI creative see faster iteration cycles and better A/B testing because production time drops from weeks to hours."
    }
  ];
    ...
    <div className="min-h-screen bg-neutral-950">
      <section className="relative px-6 pt-32 pb-20 overflow-hidden min-h-[80vh] flex items-center">
        <div className="absolute inset-0 -top-32">
          <ImageWithFallback 
            src="https://images.unsplash.com/photo-1516035069371-29a1b244cc32?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBSSUyMHBob3RvZ3JhcGh5fGVufDF8fHx8MTc2NDg2NTQ0Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
            alt="Hero background" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col h-full justify-between">
          <div className="inline-block mb-12">
            <p className="font-['Geist_Mono'] text-[#7d8187] text-xs tracking-[1.4px] uppercase">
              [ AI Photography & Image Generation ]
            </p>
          </div>
          ...
          <div className="flex justify-end mt-8">
            <p className="text-[#7d8187] max-w-md text-right leading-relaxed text-[12px] mt-[128px]">
              Professional visuals. Fraction of the cost.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-48 border-t border-[#1f2228]">
        <div className="max-w-7xl mx-auto">
          <p className="text-2xl text-white max-w-3xl mx-auto text-center leading-relaxed font-[Helvetica_Neue]">
            Traditional brand photoshoots cost $3K–$15K per day. AI photography delivers 20–50 photorealistic images for $500–$2K. Same quality, 10x faster, perfect for brands testing creative at scale.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-16">
            ...
            <p className="text-xl text-[#7d8187] max-w-2xl text-[15px] font-[Helvetica_Neue]">
              Traditional shoots are expensive and slow. You need 50+ ad variations monthly but can't afford $15K photoshoots. Stock photos look generic. Your product imagery doesn't show context or lifestyle application.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-20 border-t border-[#1f2228]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            {[
              { title: "AI Product Photography", desc: "Custom product staging, lifestyle contexts, environmental shots, multiple angles and lighting scenarios" },
              { title: "Lifestyle & Brand Imagery", desc: "Target customer personas in brand-appropriate settings, mood-specific scenes" },
              { title: "High-Volume Content Production", desc: "50–100 custom images per month for ads, social media, email campaigns, website" },
              { title: "Professional Art Direction", desc: "Prompt engineering, lighting consistency, brand color accuracy, composition refinement" },
              { title: "Post-Production Polish", desc: "Color grading, shadow/highlight refinement, background optimization, final quality control" },
              { title: "Hybrid Approach", desc: "Combine AI-generated imagery with real photography for authentic team shots and BTS content" }
            ].map((item, idx) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-[#7d8187] leading-relaxed mb-4">
                E-commerce brands, SaaS companies, real estate developers, hospitality brands, CPG products
              </p>
            </div>
            <div>
              <h2 className="text-2xl md:text-3xl text-white mb-6 font-['Helvetica'] tracking-tight">Timeline & Investment</h2>
              <p className="text-[#7d8187] leading-relaxed mb-4">
                <strong className="text-white">Timeline:</strong> 1–2 weeks per batch (20–50 images)
              </p>
              <p className="text-[#7d8187] leading-relaxed">
                <strong className="text-white">Investment:</strong> Starting at $1K per batch, $2.5K/month retainer (50–100 images/month)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto text-center space-y-10">
          <h2 className="text-4xl md:text-6xl text-white tracking-tight leading-tight">
            <span className="bg-gradient-to-br from-white from-60% to-[#7d8187] bg-clip-text text-transparent">
              Generate professional imagery at scale.
            </span>
          </h2>
