...
export function PortfolioManagement({ onNavigate }: PortfolioManagementProps) {
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="flex items-center justify-between py-6">
            <div>
              ...
              <p className="text-zinc-500 text-sm mt-1">Manage your portfolio projects and showcase work</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleSaveProject}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-white/60 mb-2 text-sm">Project Type *</label>
                    <input
                      type="text"
                ...
                <div className="mt-6 border-t border-white/10 pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <label className="block text-white/60 mb-2 text-sm">Live Site URL</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="block text-white/60 mb-2 text-sm">Case Study URL</label>
                      <input
                        type="text"
                        value={editingProject.case_study_url || ''}
                        onChange={(e) => handleFieldChange('case_study_url', e.target.value)}
                        className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded text-white focus:border-white/30 outline-none"
                        placeholder="https://..."
                        name="case_study_url"
                      />
                    ...
                    <div>
                      <label className="block text-white/60 mb-2 text-sm">Custom Button Label (Optional)</label>
                      <input
                        type="text"
                        value={editingProject.custom_link_label || ''}
                        onChange={(e) => handleFieldChange('custom_link_label', e.target.value)}
                        className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded text-white focus:border-white/30 outline-none"
                    ...
                    <div>
                      <label className="block text-white/60 mb-2 text-sm">Custom Button URL</label>
                      <input
                        type="text"
                        value={editingProject.custom_link_url || ''}
                        onChange={(e) => handleFieldChange('custom_link_url', e.target.value)}
                        className="w-full px-4 py-2 bg-white/5 border border-white/10 rounded text-white focus:border-white/30 outline-none"
                        placeholder="https://..."
