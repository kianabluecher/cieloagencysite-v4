...
export function AcquisitionChannelsPage({ onNavigate }: AcquisitionChannelsPageProps) {
  const acquisitionChannelsUrl = 'https://cieloagency.notion.site/acquisition?v=2753c154dc4481e8907e000cdef3cd8d&pvs=4';
    ...
    <div className="p-6 h-full flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="max-w-2xl w-full bg-zinc-900/50 border border-zinc-800 rounded-lg p-8 backdrop-blur-sm">
          ...
          <h2 className="text-center text-zinc-200 mb-3">Acquisition Channels Database</h2>
          <p className="text-center text-zinc-500 text-sm mb-6 font-jetbrains">
            View and manage your acquisition channels in Notion
          </p>
          
          <a
            href={acquisitionChannelsUrl}
            target="_blank"
          ...
          >
            ...
            <span>Open Acquisition Channels in Notion</span>
          </a>
        </div>
      </div>
    </div>
